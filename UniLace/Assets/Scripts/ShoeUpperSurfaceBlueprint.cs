...
namespace Obi
{
    ...
    // [CreateAssetMenu()]
    [CreateAssetMenu(fileName = "shoe upper surface blueprint", menuName = "Assets/Shoe Upper Surface Blueprint", order = 160)]
    // public class ShoeUpperSurfaceBlueprint : ObiSoftbodyBlueprintBase
    public class ShoeUpperSurfaceBlueprint : ObiSoftbodySurfaceBlueprint
    {
        [Flags]
